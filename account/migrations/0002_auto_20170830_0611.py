    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='account.UserInfoClass')),
                ('institute_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='account.UserInfoSchool')),
